...
Queries can be chained together for more complex, multi-stage query logic. In addition to subqueries and CTEs, GSQL offers more composable options with the `table as` statement, or in Markdown, by simply chaining queries.
