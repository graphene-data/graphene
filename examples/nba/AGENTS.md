...
- If unsure which reference applies, start with `@../../docs/references/graphene-sql.md`, then load additional references based on the components/functions used.
...
This is a Graphene project covering NBA data. You can find the Graphene tables in @./tables.
