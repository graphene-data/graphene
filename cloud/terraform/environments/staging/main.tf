...
module "graphene" {
  ...
  github_app_slug      = "graphene-data-staging"
  github_app_id        = "2755825"
  github_app_client_id = "Iv23liH7Zlmwp8NaQjdj"
  ...
  secrets_kms_user_arns = ["arn:aws:iam::025223626139:user/terraform-admin"]
